...
```
java -cp target/lab2-1.0-SNAPSHOT.jar co.edu.escuelaing.lab2.HttpServer
```
### Prerequisites
...
```
git clone https://github.com/CamiloCastiblanco/Lab2AREP.git
```
